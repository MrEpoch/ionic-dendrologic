...
import capacitorCookieHandler from '../../utils/cookieHandler'
import { getFrontendConfig, setRouter } from '../../utils/frontendConfig'
...
export const SuperTokensProvider: React.FC<React.PropsWithChildren<{}>> = ({
  ...
  setRouter(useHistory(), useLocation()?.pathname || window.location.pathname)
